...
export type SideStep =
  ...
  | 'chat_message'
  // 13.09: открыл пошаговую инструкцию покупки. Раньше «Купить сервер» была ссылкой, а
  // нажатия на ссылки Telegram боту не сообщает — кто пошёл покупать, было не видно.
  | 'buy_open'
  // 13.09: сервер не принял root-пароль прямо на шаге ввода (см. preflight.ts::checkSshLogin).
  | 'password_wrong'
